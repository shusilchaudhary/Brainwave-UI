...
const Services = () => {
  return (
    <Section id="how-to-use">
        ...
        <Heading title="Generative Ai made for creators" text="Brainwave Ai unlock the potential of AI-powered applications" />
        </div>
        ...
        <p className='body-2 mb-[3rem] text-n-3 '>Brainwave unlocks the power of the AI-powered application.</p>
        <ul>
        ...
        <h4 className='h4 m-4'>Photo Editing</h4>
        <p className='body-2 mb-[3rem] text-n-3 '>Automatically enhcnce your photo using our Ai app&appos;s photo editing feature.
            Try it now!
        </p>
        </div>
        <PhotChatMessage />
        ...
        <p className='body-2 mb-[2rem] text-n-3'>The world most powerful image and video generation engiene. What will you create ?</p>
